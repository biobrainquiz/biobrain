...
exports.downloadResultPdf = async (req, res) => {
    try {
        ...
        result.questions.forEach((q, i) => {
            ...
            // Check for page overflow (accounting for the 45px spacer)
            if (qY + totalBoxH > 780) {
                doc.addPage();
                drawBg(doc);
                qY = 40;
            ...
            // This defines the gap between the bottom of one question and the top of the next
            qY = currentOptY + 40;
        });
